...
//$privatekey = "6Lf8FMkSAAAAAKsfveeLDuVJBWTNOm8PvRqL9lNm";
 ...
 $publickey = "6LcbCOsSAAAAAMN1Cim7M4GZFs9DM06Fi4y3wpTV";
 $privatekey = "6LcbCOsSAAAAAGeKL84QwhBpsuSVFxDgpL_hdfI3";

#EDIT THE FOLLOWING:
$toAddress = "peterlkim1337@gmail.com";  //place your/your client's email address here - EDISON/ZEPHIR WILL ONLY EMAIL seattlecentral.edu ADDRESSES!
$toName = "Alan Baysa"; //place your client's name here
$website = "Alan Baysa Music";  //place NAME of your client's website here
$sendEmail = TRUE; //if true, will send an email, otherwise just show user data.
//$header = 'header.php'; #UNCOMMENT & PLACE REFERENCE TO YOUR HEADER FILE HERE
//$footer = 'includes/footer.php'; #UNCOMMENT & PLACE REFERENCE TO YOUR FOOTER FILE HERE
#--------------END CONFIG AREA ------------------------#
...
?>
<script type="text/javascript" src="../../includes/include/util.js"></script>
...
{#separate code block to deal with returning failed data, or no data sent yet	
	...
	<table class="contact-table">
		...
		<tr>
			<td> 
				<textarea name="Comments" cols="40" rows="4" placeholder="Comments" ></textarea>
			</td>
		</tr>
